...
#define MCAUSE_SOFTWARE  ((uint32)0x3)

#define MCAUSE_INSTR_ADDR_MISALIGNED ((uint32)0x0)
#define MCAUSE_INSTR_ACCESS_FAULT    ((uint32)0x1)
#define MCAUSE_ILLEGAL_INSTRUCTION   ((uint32)0x2)
#define MCAUSE_BREAKPOINT            ((uint32)0x3)
#define MCAUSE_LOAD_ADDR_MISALIGNED  ((uint32)0x4)
#define MCAUSE_LOAD_ACCESS_FAULT     ((uint32)0x5)
#define MCAUSE_STORE_ADDR_MISALIGNED ((uint32)0x6)
#define MCAUSE_STORE_ACCESS_FAULT    ((uint32)0x7)
#define MCAUSE_ECALL_FROM_U_MODE     ((uint32)0x8)
#define MCAUSE_ECALL_FROM_S_MODE     ((uint32)0x9)
#define MCAUSE_ECALL_FROM_M_MODE     ((uint32)0xB)
#define MCAUSE_INSTR_PAGE_FAULT      ((uint32)0xC)
#define MCAUSE_LOAD_PAGE_FAULT       ((uint32)0xD)
#define MCAUSE_STORE_PAGE_FAULT      ((uint32)0xF)
