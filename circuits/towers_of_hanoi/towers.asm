...
void list_push( struct List* list, int val )
{
  ...
  4000b0:	f8470713          	addi	a4,a4,-124 # 80000030 <g_nodeFreeList>
...
int list_pop( struct List* list )
{
  ...
  4000f8:	f3c68693          	addi	a3,a3,-196 # 80000030 <g_nodeFreeList>
...
int main( int argc, char* argv[] )
{
  ...
  40039c:	c9870713          	addi	a4,a4,-872 # 80000030 <g_nodeFreeList>
  ...
  4003ac:	00600693          	li	a3,6
  4003b0:	00d72023          	sw	a3,0(a4)
  g_nodePool[NUM_DISCS-1].next = 0;
  4003b4:	0207a623          	sw	zero,44(a5)
  g_nodePool[NUM_DISCS-1].val = 99;
  4003b8:	06300713          	li	a4,99
  4003bc:	02e7a423          	sw	a4,40(a5)
  for ( i = 0; i < (NUM_DISCS-1); i++ ) {
  4003c0:	7fc00797          	auipc	a5,0x7fc00
  4003c4:	c4878793          	addi	a5,a5,-952 # 80000008 <g_nodePool+0x8>
  4003c8:	00000713          	li	a4,0
  4003cc:	00500613          	li	a2,5
    g_nodePool[i].next = &(g_nodePool[i+1]);
  4003d0:	00070693          	mv	a3,a4
  4003d4:	00170713          	addi	a4,a4,1
  4003d8:	fef7ae23          	sw	a5,-4(a5)
    g_nodePool[i].val = i;
  4003dc:	fed7ac23          	sw	a3,-8(a5)
  for ( i = 0; i < (NUM_DISCS-1); i++ ) {
  4003e0:	00878793          	addi	a5,a5,8
  4003e4:	fec716e3          	bne	a4,a2,4003d0 <main+0x74>
  }

  towers_init( &towers, NUM_DISCS );
  4003e8:	00600593          	li	a1,6
  4003ec:	00010513          	mv	a0,sp
  4003f0:	d61ff0ef          	jal	400150 <towers_init>
  towers_solve( &towers );
#endif
  ...
  towers_clear( &towers );
  4003f4:	00010513          	mv	a0,sp
  4003f8:	dbdff0ef          	jal	4001b4 <towers_clear>
  //setStats(1);
  towers_solve( &towers );
  4003fc:	00010513          	mv	a0,sp
  400400:	eb5ff0ef          	jal	4002b4 <towers_solve>
  //setStats(0);
  
  // Chek the results
  res = towers_verify( &towers );
  400404:	00010513          	mv	a0,sp
  400408:	ed5ff0ef          	jal	4002dc <towers_verify>
  40040c:	00050413          	mv	s0,a0
  printstr("Result = "); printhex(res); printstr("\n");
  400410:	00000517          	auipc	a0,0x0
  400414:	08850513          	addi	a0,a0,136 # 400498 <main+0x13c>
  400418:	c05ff0ef          	jal	40001c <printstr>
  40041c:	00040513          	mv	a0,s0
  400420:	c25ff0ef          	jal	400044 <printhex>
  400424:	00000517          	auipc	a0,0x0
  400428:	07050513          	addi	a0,a0,112 # 400494 <main+0x138>
  40042c:	bf1ff0ef          	jal	40001c <printstr>
 
  unsigned int count = COUNTER;
  400430:	ffff07b7          	lui	a5,0xffff0
  400434:	0207a483          	lw	s1,32(a5) # ffff0020 <__stack_init+0x7bff0024>
  printstr("Total Clock Ticks = "); printhex(count); printstr("\n"); 
  400438:	00000517          	auipc	a0,0x0
  40043c:	06c50513          	addi	a0,a0,108 # 4004a4 <main+0x148>
  400440:	bddff0ef          	jal	40001c <printstr>
  400444:	00048513          	mv	a0,s1
  400448:	bfdff0ef          	jal	400044 <printhex>
  40044c:	00000517          	auipc	a0,0x0
  400450:	04850513          	addi	a0,a0,72 # 400494 <main+0x138>
  400454:	bc9ff0ef          	jal	40001c <printstr>

  return res;
}
  400458:	00040513          	mv	a0,s0
  40045c:	02c12083          	lw	ra,44(sp)
  400460:	02812403          	lw	s0,40(sp)
  400464:	02412483          	lw	s1,36(sp)
  400468:	03010113          	addi	sp,sp,48
  40046c:	00008067          	ret
